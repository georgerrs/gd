          ...
          <Row className={s.formGroup}>
            ...
            <Col componentClass={ControlLabel} xs={12} sm={9} md={9} lg={9}>
              <Field name="email" 
                ...
                className={s.formControlInput} 
              />
              <p className={s.labelText}>{formatMessage(messages.emailInfo)} 
                <a href="#" className={cx(s.modalCaptionLink, s.modalCaptionLinkLarge)}> {formatMessage(messages.learnMore)}</a>
              </p>
            </Col>
          </Row>
