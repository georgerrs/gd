...
class PaymentReceipt extends React.Component {
    ...
    render() {
        ...
        if(data === null){
            ...
            const { data, data: { id, checkIn, checkOut, confirmationCode, createdAt, updatedAt }} = this.props;
            const { data: { basePrice, cleaningPrice, total, discount, discountType, guestServiceFee, currency }} = this.props;
