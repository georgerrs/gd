...
const messages = defineMessages({
  ...
  timeToExpire: {
    ...
    defaultMessage: 'Your guest have 24 hours to repond to this or it will get expired',
  ...
  cancellingInfo: {
    ...
    defaultMessage: 'Cancelling a guest`s reservation can disrupt their plans and have serious implications on their tripCancelling a guest`s reservation can disrupt their plans and have serious implications on their trip',
    description: 'Trip before canceling',
  },
  started: {
    id: 'rentall.started',
